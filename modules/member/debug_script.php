      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding-bottom: 0px;">
          ...
          <ul class="bold_li" style="margin:20px 10px;">
            ...
            <li>
              <p>Offers Applicable only for 50K To U4LTTBE</p>
            </li>


            <li>
              <p>Creating 30 mobile / tablet / laptop winners from your team is mandatory</p>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding-bottom: 0px;">
          ...
          <ul class="bold_li" style="margin:20px 10px;">
            ...
            <p style="text-align: center; font-size: 12px; margin:5px 0px">Terms And Conditions Apply : -
            <p>
...
<div class="">
  <div class="modal fade modal-newspaper" id="credit_card_bitcoin" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" style="z-index: 1111111 !important;">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header" style="background-color: #3E4095">
          <h4 style="text-align: center;margin-top: 10px;color: white;font-size: 18px">Bank Account Detail</h4>
          <button class="close close_box" style="top: 5PX !important;padding: 0px 0px !important;" data-dismiss="modal" aria-label="Close"><img src="https://www.freeiconspng.com/thumbs/close-icon/close-icon-30.png" width="30px"></button>
        </div>
          ...
          <div class="row" style="margin-top: 15px;">
            <div class="col-sm-12">
              <p>
                ...
                ACCOUNT NO. <b>919118723203</b><br><br>
                IFSC CODE. PYTM0123456 <br><br>
                Account Holder Name. Google Recaptcha <br><br>
                UPI ID= <b> adarshpushpendra@ybl</b>
                Only Payment Issue- Whatsapp for Payment Link on<br> <a href="https://wa.me/919118723203" target="_blank" style="color: blue"><u> Click Here</u> </a><br><br>
  ...
  function sa_request_form(ele) {
    ...
    if (hasError == 1) {
      ...
      jQuery.ajax({
        ...
        cache: false,
        beforeSend: function() {
          jQuery(".btn-quirk").text('Validating ...').prop('disabled', true);
        },
  ...
  function change_password_fun(ele) {
    ...
    if (hasError == 1) {
      ...
      jQuery.ajax({
        ...
        cache: false,
        beforeSend: function() {
          jQuery("#change_password_submit").text('Validating ...').prop('disabled', true);
        },
        success: function(res) {
  ...
  <div class="modal-dialog modal-simple">
    <div class="modal-content">
      ...
      <div class="modal-body"><br>
        <div class="row">
          <div class="col-sm-6">
            <center><a href="https://www.oxiinc.com/customers/lean_lead_ticket" target="_blank"><button type="button" class="btn btn-primary" style="width: 50%"> Ticket </button></a></center>
          </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body"><br>
        <div class="row">
          <div class="col-sm-12">
            <center>
              <p style="color: red;font-size: 16px;font-weight: 600">Sorry!! Amount is Insufficient</p>
            </center>
          </div>
  ...
  <div class="modal-dialog modal-simple">
    <div class="modal-content">
      ...
      <div class="modal-body"><br>
        <div class="row">
          <div class="col-sm-6">
            <center><a href="https://www.oxiinc.com/customers/Digital_champ_ticket" target="_blank"><button type="button" class="btn btn-primary" style="width: 50%"> Ticket </button></a></center>
          </div>
          <div class="col-sm-6" id="qr_code">
            <center>
            </center>
  ...
  <div class="modal-dialog modal-simple">
    <div class="modal-content">
      ...
      <div class="modal-body"><br>
        <div class="row">
          <div class="col-sm-6">
            <center><a href="https://www.oxiinc.com/customers/go_goa_ticket" target="_blank"><button type="button" class="btn btn-primary" style="width: 50%"> Ticket </button></a></center>
          </div>
          <div class="col-sm-6" id="qr_code">
            <center>
            </center>
      ...
      <div class="modal-body" id="zonal_head_submit_form">
        ...
        <div class="row" id="advertisement_zonal_head">
          ...
          <div class="col-sm-12"><br><br>
            ...
            <center>
              <p> <button type="button" class="btn btn-primary" onclick="zonal_head_request_model_show();">Submit</button> </p>
            </center>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header" style="background-color: #3E4095">
          ...
          <button class="close close_box" style="top: -13PX !important;padding: 0px 4px !important;" data-dismiss="modal" aria-label="Close"><img src="../../images/cross.png" width="30px"></button>
        </div>
